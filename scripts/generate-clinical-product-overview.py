...
def build(output_path):
    ...
    pdf.drawString(margin, footer_y + 38, "PRIMARY INQUIRY CONTACT")
    pdf.setFillColor(DARK)
    pdf.setFont("Helvetica-Bold", 9)
    pdf.drawString(margin, footer_y + 26, "Drew Zaun")
    pdf.setFont("Helvetica-Bold", 8.5)
    pdf.drawString(252, footer_y + 26, "Tom Goetz")
    pdf.setFillColor(MUTED)
    pdf.setFont("Helvetica", 7.3)
    pdf.drawString(margin, footer_y + 14, "Founder & Chief Sales & Marketing Officer")
    pdf.drawString(252, footer_y + 14, "Co-Owner & Head of Product")
    pdf.setFillColor(NAVY)
    pdf.setFont("Helvetica-Bold", 7.8)
    pdf.drawString(margin, footer_y - 1, "dzaun@akoyamedical.com")
    pdf.setFillColor(MUTED)
    pdf.setFont("Helvetica", 7.1)
    pdf.drawString(252, footer_y - 1, "Product support is routed through Drew")
    pdf.setFillColor(NAVY)
    pdf.setFont("Helvetica-Bold", 7.8)
    pdf.drawRightString(width - margin, footer_y + 26, "515-587-5863")
    pdf.drawRightString(width - margin, footer_y + 9, "akoyamedical.com")
    pdf.setFillColor(MUTED)
